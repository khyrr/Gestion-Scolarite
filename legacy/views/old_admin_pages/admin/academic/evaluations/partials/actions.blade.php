<div class="dropdown">
    <button class="google-icon-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Actions pour l'évaluation {{ $evaluation->titre }}" onclick="event.stopPropagation()">
    ...
    <ul class="dropdown-menu dropdown-menu-end google-dropdown">
        <li>
            <a class="dropdown-item google-dropdown-item" href="{{ route('admin.evaluations.show', $evaluation->id_evaluation) }}">
                {{ __('Voir les notes') }}
            </a>
        </li>
        @admin
        <li>
            <a class="dropdown-item google-dropdown-item" href="{{ route('admin.evaluations.edit', $evaluation->id_evaluation) }}">
                {{ __('Modifier') }}
            </a>
        </li>
