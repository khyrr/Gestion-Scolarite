...
<head>
    ...
    <title>{{ __('Confirmer le mot de passe') }} - {{ config('app.name', 'Gestion Scolaire') }}</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <h1 class="auth-title">{{ __('Confirmer le mot de passe') }}</h1>
                <p class="auth-subtitle">{{ __('Veuillez confirmer votre mot de passe avant de continuer.') }}</p>
            </div>
