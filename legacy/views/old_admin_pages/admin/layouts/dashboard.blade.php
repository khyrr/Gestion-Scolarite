...
<head>
    ...
    <style>
        ...
        #nprogress .peg {
            box-shadow: 0 0 10px var(--primary-color, #1a73e8), 0 0 5px var(--primary-color, #1a73e8) !important;
        }

        #nprogress .spinner-icon {
            border-top-color: var(--primary-color, #1a73e8) !important;
            border-left-color: var(--primary-color, #1a73e8) !important;
        }
    </style>
