...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end google-dropdown">
        <li>
            <a class="dropdown-item google-dropdown-item" href="{{ route('enseignants.show', $teacher->id_enseignant) }}">
                {{ __('app.voir') }}
            </a>
        </li>
        @admin
        <li>
            <a class="dropdown-item google-dropdown-item" href="{{ route('enseignants.edit', $teacher->id_enseignant) }}">
                {{ __('app.modifier') }}
            </a>
        </li>
        <li><hr class="google-dropdown-divider"></li>
        <li>
            <form method="POST" action="{{ route('enseignants.destroy', $teacher->id_enseignant) }}" class="d-inline">
                @csrf
                @method('DELETE')
