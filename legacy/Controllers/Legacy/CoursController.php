...
class CoursController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('old_admin_pages.admin.academic.cours.index')->with('cours', $cours);
        ;
    }
    ...
    public function create()
    {
        ...
        return view('old_admin_pages.admin.academic.cours.create', compact('classes', 'enseignants', 'matieres'));
    }
    ...
    public function show(Cours $cour)
    {
        ...
        return view('old_admin_pages.admin.academic.cours.show', compact('cours'));
    }
    ...
    public function spectacle()
    {
        ...
        return view('old_admin_pages.admin.academic.cours.spectacle', $data);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('old_admin_pages.admin.academic.cours.edit', compact('Cours', 'classes', 'enseignants', 'matieres'));
    }
