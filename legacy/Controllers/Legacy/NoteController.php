...
class NoteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('old_admin_pages.admin.academic.notes.index', compact('notes', 'classes', 'evaluations', 'matieres', 'statistics'));
    }
    ...
    public function edit(Note $note)
    {
        ...
        return view('old_admin_pages.admin.academic.notes.edit', compact('note'));
    }
    ...
    public function transcript(Request $request, Etudiant $etudiant, $trimestre = null)
    {
        ...
        return view('old_admin_pages.admin.academic.notes.transcript', compact(
            'etudiant',
            'notes',
            'notesByMatiere',
            'statistics',
    ...
    public function transcriptIndex(Request $request)
    {
        ...
        return view('old_admin_pages.admin.academic.notes.transcript-index', compact('etudiants', 'classes'));
    }
}
